...
set WHS_dir_client=""D:\BibliothŠques Windows\Documents\whs-basic\whs-project-iut\client\""
set WHS_dir_server=""D:\BibliothŠques Windows\Documents\whs-basic\whs-project-iut\server\""
